...
export const fetchOrders = () => {
    return async (dispatch, getState) => {
        ...
        try {
            const response = await fetch(`https://rn-complete-guide-dda6d.firebaseio.com/orders/${userId}.json`);
...
export const addOrder = (cartItems, totalAmount) => {
    ...
    return async (dispatch, getState) => {
        ...
        const response = await fetch(`https://rn-complete-guide-dda6d.firebaseio.com/orders/${userId}.json?auth=${token}`, {
            method: 'POST',
            headers: {
